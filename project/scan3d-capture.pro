...
unix:OPENCV_DIR = "/usr/include/opencv4"
unix:OPENCV_LIB_DIR = "/usr/lib"
...
CV_LIB_NAMES = core imgproc highgui calib3d features2d flann imgcodecs
...
unix:!macx {
    QMAKE_LFLAGS += -Wl,-rpath=$$OPENCV_LIB_DIR
}
...
INCLUDEPATH += $$SOURCEDIR $$UI_DIR $$OPENCV_DIR
